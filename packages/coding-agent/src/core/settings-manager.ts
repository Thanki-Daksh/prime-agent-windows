...
export interface SecuritySettings {
	strictPathShield?: boolean; // default: true
	blockDestructiveCommands?: boolean; // default: true
	redactSensitiveEnv?: boolean; // default: true
}
...
export interface Settings {
	...
	enableAgentsSkills?: boolean; // default: false - scan external ~/.agents/skills and ancestor .agents/skills
...
export class SettingsManager {
	...
	getSecuritySettings(): SecuritySettings {
		return {
			strictPathShield: this.settings.security?.strictPathShield ?? true,
			blockDestructiveCommands: this.settings.security?.blockDestructiveCommands ?? true,
			redactSensitiveEnv: this.settings.security?.redactSensitiveEnv ?? true,
		};
	}

	setSecuritySettings(security: SecuritySettings): void {
		this.globalSettings.security = {
			...this.globalSettings.security,
			...security,
		};
