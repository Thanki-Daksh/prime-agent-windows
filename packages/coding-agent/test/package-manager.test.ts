...
Content`,
				...
				symlinkSync(sharedExtensionsDir, join(tempDir, ".prime", "agent", "extensions"), directoryLinkType);
				symlinkSync(sharedSkillsDir, join(tempDir, ".prime", "agent", "skills"), directoryLinkType);
				symlinkSync(sharedPromptsDir, join(tempDir, ".prime", "agent", "prompts"), directoryLinkType);
				symlinkSync(sharedThemesDir, join(tempDir, ".prime", "agent", "themes"), directoryLinkType);
	...
	describe(".agents/skills auto-discovery", () => {
		it("should not discover .agents/skills by default when enableAgentsSkills is false", async () => {
		...
		it("should scan .agents/skills from cwd up to git repo root when enableAgentsSkills is true", async () => {
